...
int main(int argc, char** argv)
{
	...
	for (int i = 0; i < 31; i++)
	{
		...
		grb->CreateWorldBox(Vector2(0.5f, 0.5f), grounds[i]->GetTransform()->m_Position, ColliderFilters::Environment, ColliderFilters::Player);
	...
	for (int i = 0; i < 31; i++)
	{
		...
		rrb->CreateWorldBox(Vector2(0.5f, 0.5f), roofs[i]->GetTransform()->m_Position, ColliderFilters::Environment, ColliderFilters::Player);
	...
	for (int i = 0; i < 17; i++)
	{
		...
		rwrb->CreateWorldBox(Vector2(0.5f, 0.5f), 0.0f, rightWalls[i]->GetTransform()->m_Position, ColliderFilters::Environment, ColliderFilters::Player);
	...
	for (int i = 0; i < 17; i++)
	{
		...
		lwrb->CreateWorldBox(Vector2(0.5f, 0.5f), 0.0f, leftWalls[i]->GetTransform()->m_Position, ColliderFilters::Environment, ColliderFilters::Player);
