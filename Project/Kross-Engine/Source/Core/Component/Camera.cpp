...
namespace Kross
{
    void Camera::OnStart()
    {
        ...
        m_View = glm::translate(Matrix4(1.0f), Vector3(-GetLinkObject()->GetTransform()->m_Position, 0.0f)) * glm::rotate(Matrix4(1.0f), glm::radians(GetLinkObject()->GetTransform()->m_Rotation), Vector3(0.0f, 0.0f, -1.0f));
    }
